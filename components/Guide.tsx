            ...
            max-container w-full pb-24">
                ...
                lg:gap-10">
                    ...
                    <p className="regular-16 text-gray-30 xl:max-w-[520px]">
                        ...
                        Invite your friends, relatives and friends to have fun in the wilderness through the valley and reach the top of the 
                        mountain
                    </p>
                </div>
            </div>
                ...
                rounded-3xl border shadow-md md:left-[5%] lg:top-20">
                    ...
                    <div className="flexBetween flex-col">
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <h4 className="bold-20 mt-2">Wonorejo Pasuruank</h4>
                        </div>
                    </div>
                </div>
            </div>
